...
export default class VoiceManager {
  constructor(page) {
    this._page = page; //判断是否需要使用高版本语音播放接口

    this.innerAudioContext = wx.createInnerAudioContext(); //在该类被初始化时，绑定语音点击播放事件
  ...
  _startPlayVoice(dataset) {
    ...
    if (latestPlayVoicePath && latestPlayVoicePath !== currentPlayItem.content) {

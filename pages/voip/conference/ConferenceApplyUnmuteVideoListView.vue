<template>
    <div class="apply-unmute-container">
                ...
                <li v-for="(participant, i) in applyUnmuteParticipantList" :key="i">
                    <div class="participant-user">
                        ...
                        <div class="action-container">
                            <button size="mini" @click="conferenceManager.approveUnmute(participant.uid, false,  true)">同意</button>
                            <button  size="mini" @click="conferenceManager.approveUnmute(participant.uid, false, false)">拒绝</button>
                        </div>
                    </div>
                </li>
            </ul>
        ...
        <div class="action-all-container">
            <button size="mini" @click="conferenceManager.approveAllUnmute(false, true)">全部同意</button>
            <button size="mini" @click="conferenceManager.approveAllUnmute(false, false)">全部拒绝</button>
        </div>
    </div>

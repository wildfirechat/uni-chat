...
class WfcImpl {
    ...
    getUserMessagesV2(userId, conversation, fromIndex, before, count, successCB, failCB) {
        uniWfcClient.getUserMessagesV2(userId, JSON.stringify(conversation), fromIndex, before, count, withUser, ...this._wrapperGetMessageCallbacks(successCB, failCB));
    }

    getUserMessagesExV2(userId, conversationTypes, lines, fromIndex, before, count, contentTypes, successCB, failCB) {
        uniWfcClient.getUserMessagesExV2(userId, conversationTypes, lines, fromIndex, before, count, contentTypes, withUser, ...this._wrapperGetMessageCallbacks(successCB, failCB));
    }
    ...
    sendConferenceRequest(sessionId, roomId, request, data, advance, callback) {
        uniWfcClient.sendConferenceRequest(sessionId, roomId, request, data, advance === true,
            (resp) => {
